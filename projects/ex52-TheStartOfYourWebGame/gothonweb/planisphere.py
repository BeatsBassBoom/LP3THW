...
in its container. There's a keypad lock on the box an you need the
...
of them has an even uglier clown costume than that last. They haven't
...
blaster at ti. You then jump back through the door, punch the close
